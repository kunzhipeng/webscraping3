...
class PersistentDict:
    ...
    >>> os.remove(filename)
    """
    def __init__(self, filename='cache.db', expires=None, timeout=DEFAULT_TIMEOUT, isolation_level=None, num_caches=1, use_md5hash=True):
        ...
        if self.num_caches == 1:
            ...
            if isinstance(key, int):
                ...
                if not self.use_md5hash:
                    ...
                    hashvalue = md5.md5(key.encode('UTF-8')).hexdigest()
